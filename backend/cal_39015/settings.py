"""
Django settings for cal_39015 project.
...
WSGI_APPLICATION = 'cal_39015.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "cal_39015 API",
    "DESCRIPTION": "API documentation for cal_39015 App",
    "VERSION": "v1",
}
